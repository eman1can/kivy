...
The :class:`HoverButton` is a :class:`~kivy.uix.label.Label` with associated actions
that are triggered when the button is pressed/hovered (or released after a
click/touch/hover). To configure the button, the same properties (padding,
font_size, etc) and
:ref:`sizing system <kivy-uix-label-sizing-and-text-content>`
are used as for the :class:`~kivy.uix.label.Label` class::

    button = HoverButton(text='Hello world', font_size=14)

To attach a callback when the button is pressed (clicked/touched/hovered), use
...
class HoverButton(HoverButtonBehavior, Label):
    '''HoverButton class, see module documentation for more information.

    .. versionadded:: 2.0.0rc3
        Added new hover button class
    ...
    background_hover_normal = StringProperty('atlas://data/images/defaulttheme/button')
    '''Background image of the button used for the default graphical
        representation when the button is not pressed and is hovered over.

        .. versionadded:: 1.0.4

        :attr:`background_hover_normal` is a :class:`~kivy.properties.StringProperty`
        and defaults to 'atlas://data/images/defaulttheme/button'.
        '''

    background_hover_down = StringProperty('atlas://data/images/defaulttheme/button_pressed')
    '''Background image of the button used for the default graphical
    representation when the button is pressed and hovered over.

    .. versionadded:: 1.0.4

    :attr:`background_hover_down` is a :class:`~kivy.properties.StringProperty` and
    defaults to 'atlas://data/images/defaulttheme/button_pressed'.
    '''
